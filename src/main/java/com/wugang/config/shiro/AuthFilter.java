...
import com.wugang.util.HttpContextUtil;
import com.wugang.util.TokenUtil;
...
//            result.put("msg", "请先登录");
            ...
            String json = MAPPER.writeValueAsString(CommonResponse.fail("请先登陆"));
...
//            result.put("msg", "登录凭证已失效，请重新登录");
            String json = MAPPER.writeValueAsString(CommonResponse.fail("登录凭证已失效，请重新登录"));
            httpResponse.getWriter().print(json);
